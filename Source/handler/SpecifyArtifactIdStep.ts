...
export class SpecifyArtifactIdStep implements IStep {
	...
	private static specifyArtifactIdStep: SpecifyArtifactIdStep =
		new SpecifyArtifactIdStep();
	...
	public resetDefaultInput(): void {
		this.defaultInput = workspace
			.getConfiguration("spring.initializr")
			.get<string>("defaultArtifactId");
	}
	...
	private async specifyArtifactId(
		projectMetadata: IProjectMetadata,
	): Promise<boolean> {
