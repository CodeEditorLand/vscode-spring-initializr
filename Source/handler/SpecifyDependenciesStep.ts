...
export class SpecifyDependenciesStep implements IStep {
	...
	private static specifyDependenciesStep: SpecifyDependenciesStep =
		new SpecifyDependenciesStep();
					...
					pickBox.onDidHide(() => {
						reject(
							new OperationCanceledError(
								"Canceled on dependency selection.",
							),
						);
					}),
