...
export class SpecifyLanguageStep implements IStep {
	...
	private static specifyLanguageStep: SpecifyLanguageStep =
		new SpecifyLanguageStep();
	...
	private async specifyLanguage(
		projectMetadata: IProjectMetadata,
	): Promise<boolean> {
		const language: string =
			projectMetadata.defaults.language ||
			workspace
